...
class CardsScene : Scene() {
    ...
    override suspend fun Container.sceneInit() {
        ...
        card("KorGE Engine", resourcesVfs["korge.png"].readBitmap()).setDraggableRules()
        card("Тест отображения цветного предмета", resourcesVfs["d1.png"].readBitmap()).setDraggableRules()
        card("Рассвет", resourcesVfs["q3.png"].readBitmap()).setDraggableRules()
    }
}